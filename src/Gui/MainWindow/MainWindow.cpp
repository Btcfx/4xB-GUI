...
const char COMMUNITY_FORUM_URL[] = "http://4xbitcoinproject.org";
const char REPORT_ISSUE_URL[] = "http://4xbitcoinproject.org";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
//  setWindowTitle(tr("4xbitcoin Wallet %1").arg(Settings::instance().getVersion()));
