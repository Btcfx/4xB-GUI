...
public:
    ...
    QAction *m_about4xbitcoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/4xbitcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_about4xbitcoinAction = new QAction(MainWindow);
        m_about4xbitcoinAction->setObjectName(QStringLiteral("m_about4xbitcoinAction"));
        m_about4xbitcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_about4xbitcoinAction);
        ...
        QObject::connect(m_about4xbitcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_about4xbitcoinAction->setText(QApplication::translate("MainWindow", "About 4xbitcoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND XAO", 0));
